...
from handlers.routers_for_admin.wait_username_add_admin import get_username_for_add_admin_rout
from handlers.routers_for_admin.wait_username_del_admin import get_username_for_del_admin_rout
from handlers.routers_for_admin.wait_username_ban_user import get_username_for_ban_user_rout
from handlers.routers_for_admin.wait_username_unban_user import get_username_for_unban_user_rout
...
from handlers.callback_query import callback_query_rout_for_is_mailing, callback_query_rout_for_disabled_tags
from handlers.callback_query import callback_query_rout_for_add_or_delete_tags, WaitDisabledTags
...
async def callback_query_routing_for_is_mailing(callback_query: types.CallbackQuery) -> None:
    await callback_query_rout_for_is_mailing(callback_query)


@router.callback_query(F.data == 'disabled_tags')
async def callback_query_routing_for_disabled_tags(callback_query: types.CallbackQuery) -> None:
    await callback_query_rout_for_disabled_tags(callback_query)


@router.callback_query(F.data.endswith('tag'))
async def callback_query_routing_for_add_or_delete_tags(callback_query: types.CallbackQuery, state: FSMContext) -> None:

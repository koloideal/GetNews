    ...
    match callback.data:
        case "is_mailing_OFF":
            ...
            builder.add(
                InlineKeyboardButton(
                    text="Disabled Tags", callback_data="disabled_tags"
                ),
                InlineKeyboardButton(
                    text="Mailing:  ON ✅", callback_data="is_mailing_ON"
                ),
            )
        ...
        case "is_mailing_ON":
            ...
            builder.add(
                ...
                InlineKeyboardButton(
                    text="Mailing:  OFF ❌", callback_data="is_mailing_OFF"
                ),
            )
...
async def callback_query_rout_for_disabled_tags(callback: types.CallbackQuery):
    ...
    builder.add(
        InlineKeyboardButton(text="Add Tag/Tags", callback_data="add_tag"),
...
async def callback_query_rout_for_add_or_delete_tags(
    ...
    match action:
        case "add_tag":
            await callback.message.answer(
                'Enter the tag without quotes in the "example" format if there is one, '
        ...
        case "delete_tag":
            ...
            await callback.message.answer(
                "Enter the disabled tag to delete without quotes, now your disabled tags are:"
                f" {tags}"
            )
        ...
        case "delete_all_tag":
            ...
            await callback.message.answer(
                "All disabled tags have been successfully deleted"
            )
